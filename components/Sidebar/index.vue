<template>
    ...
    class="sidebar-container">
        ...
        <div class="w-100  d-flex flex-column px-2 mt-10">
            <div 
            class="d-flex px-2 py-1 rounded app_pointer align-center" 
            ...
            <div 
            class="d-flex px-2 py-1 mt-1 rounded app_pointer align-center" 
            ...
            >
                ...
                <span 
                class="app-font-size-12 app-font-weight-400 px-2 pt-2" 
                v-if="isOpen"
                >Ware House</span>
            </div>
            <div 
